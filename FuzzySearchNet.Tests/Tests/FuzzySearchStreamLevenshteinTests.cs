...
/// </summary>
public class FuzzySearchStreamLevenshteinTests
{
    ...
    [Test]
    public async Task Test2DeletionsBufferStart()
    {
        var pattern = "pattern";
        var text = "atern----";
    ...
    [Test]
    public async Task TestZeroMaxDistanceNoMatch2()
    {
        var word = "pattern";
        var text = "paxxern";
    ...
    [Test]
    public async Task TestSingleDeletionBufferStart()
    {
        var word = "pattern";
        var text = "patern----";
    ...
    [Test]
    public async Task TestSingleDeletionBufferMiddle()
    {
        var word = "pattern";
        var text = "--patern--";
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutive()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutive2()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutiveSubstitutions()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutiveInsertion()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestOverlappingMatches()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutiveDeletion()
    {
        var word = "pattern";
    ...
    [Test]
    public async Task TestLevenshteinLinq()
    {
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutiveCaseInsensitive()
    {
        var word = "PATTERN";
        var text = "--patternpattern--";

        var results = await FuzzySearch.FindAsync(word, new MemoryStream(Encoding.UTF8.GetBytes(text)), new FuzzySearchOptions(2, true)).ToListAsync();
    ...
    [Test]
    public async Task TestMultipleMatchesConsecutiveCaseInsensitive2()
    {
        var word = "pattern";
        var text = "--PATTERNPATTERN--";
